...
class LoginPage(BasePage):
    ...
    def loginByPassword(self, account, password):
        ...
        self.load_yaml(LoginPage.datapath,"loginByPassword",var1=account,var2=password)
        return self
    ...
    def back(self):
        self.load_yaml(LoginPage.datapath,"back")
    ...
    def getErrorMsg(self):
        ...
        # return msg
        self.load_yaml(LoginPage.datapath,"getErrorMsg")
        return BasePage.attribute_value
